    ...
    with connection.cursor() as cursor:
        ...
        try:
            cursor.execute("""
                ...
                WHERE table_name = 'settlement_center_settlementitem' 
            ...
            for constraint in constraints:
                ...
                try:
                    cursor.execute(f"""
                        ALTER TABLE settlement_center_settlementitem 
            ...
            try:
                cursor.execute("""
                    ALTER TABLE settlement_center_settlementitem 
                    DROP CONSTRAINT IF EXISTS settlement_center_settlementitem_opinion_id_fkey
                """)
            except:
                pass
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('settlement_center', '0013_add_service_fee_cap_fee_area_scale'),
    ]
