    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('company', '公司计划'), ('personal', '个人计划')], default='company', help_text='company=公司计划, personal=个人计划', max_length=20, verbose_name='计划层级')),
                ...
                ('status', models.CharField(choices=[('draft', '草稿'), ('published', '已发布'), ('accepted', '已接收'), ('in_progress', '执行中'), ('completed', '已完成'), ('cancelled', '已取消')], default='draft', max_length=20, verbose_name='计划状态')),
                ...
                ('acceptance_criteria', models.TextField(blank=True, help_text='明确说明如何判定计划完成，提交审批前必填', max_length=2000, verbose_name='验收标准')),
                ('start_time', models.DateTimeField(verbose_name='计划开始时间')),
                ('end_time', models.DateTimeField(verbose_name='计划结束时间')),
                ('duration_days', models.IntegerField(default=0, help_text='自动计算', verbose_name='计划周期（天）')),
                ('published_at', models.DateTimeField(blank=True, help_text='状态变为 published 时自动记录', null=True, verbose_name='发布时间')),
                ('accepted_at', models.DateTimeField(blank=True, help_text='状态变为 accepted 时自动记录', null=True, verbose_name='接收时间')),
                ('completed_at', models.DateTimeField(blank=True, help_text='状态变为 completed 时自动记录', null=True, verbose_name='完成时间')),
                ('collaboration_plan', models.TextField(blank=True, help_text='如果选择了协作人员，必须填写协作计划', verbose_name='协作计划')),
                ('related_project', models.CharField(blank=True, help_text='项目信息来源于商机管理', max_length=200, verbose_name='关联项目')),
                ('progress', models.DecimalField(decimal_places=2, default=0, help_text='百分比，0-100', max_digits=5, verbose_name='执行进度')),
                ('is_overdue', models.BooleanField(db_index=True, default=False, help_text='周计划提交是否逾期', verbose_name='是否逾期')),
                ('overdue_days', models.IntegerField(default=0, help_text='周计划逾期天数', verbose_name='逾期天数')),
                ('risk_level', models.CharField(blank=True, choices=[('low', '低风险'), ('medium', '中风险'), ('high', '高风险'), ('critical', '严重风险')], default='low', help_text='周计划逾期风险等级', max_length=20, verbose_name='风险等级')),
                ('submission_deadline', models.DateTimeField(blank=True, help_text='周计划提交截止时间（每周五18:00）', null=True, verbose_name='提交截止时间')),
                ('created_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='plans', to='system_management.ourcompany', verbose_name='公司')),
                ...
                ('org_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='org_plans', to='system_management.department', verbose_name='部门')),
                ('owner', models.ForeignKey(blank=True, help_text='个人计划必填，公司计划可为空', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='owned_plans', to=settings.AUTH_USER_MODEL, verbose_name='计划所有者')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('company', '公司目标'), ('personal', '个人目标')], default='company', help_text='company=公司目标, personal=个人目标', max_length=20, verbose_name='目标层级')),
                ...
                ('goal_period', models.CharField(choices=[('annual', '年度目标'), ('half_year', '半年目标'), ('quarterly', '季度目标')], max_length=20, verbose_name='目标周期')),
                ('status', models.CharField(choices=[('draft', '制定中'), ('published', '已发布'), ('accepted', '已接收'), ('in_progress', '执行中'), ('completed', '已完成'), ('cancelled', '已取消')], default='draft', max_length=20, verbose_name='目标状态')),
                ...
                ('description', models.TextField(blank=True, max_length=2000, verbose_name='目标描述')),
                ...
                ('duration_days', models.IntegerField(default=0, help_text='自动计算', verbose_name='目标周期（天）')),
                ('published_at', models.DateTimeField(blank=True, help_text='状态变为 published 时自动记录', null=True, verbose_name='发布时间')),
                ('accepted_at', models.DateTimeField(blank=True, help_text='状态变为 accepted 时自动记录', null=True, verbose_name='接收时间')),
                ('completed_at', models.DateTimeField(blank=True, help_text='状态变为 completed 时自动记录', null=True, verbose_name='完成时间')),
                ...
                ('owner', models.ForeignKey(blank=True, help_text='个人目标必填，公司目标可为空', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='owned_goals', to=settings.AUTH_USER_MODEL, verbose_name='目标所有者')),
                ...
                ('responsible_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='goals', to='system_management.department', verbose_name='所属部门')),
                ('responsible_person', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='responsible_goals', to=settings.AUTH_USER_MODEL, verbose_name='负责人')),
            ],
            options={
                'verbose_name': '战略目标',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_confirmed', models.BooleanField(default=True, editable=False, help_text='是否为系统自动确认的不作为记录。当 is_confirmed=True 时，系统已自动确认该期间内责任人无任何行为或反馈。', verbose_name='系统确认')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_end_time', models.DateTimeField(default=django.utils.timezone.now, help_text='记录调整前的截止时间', verbose_name='原截止时间')),
                ('new_end_time', models.DateTimeField(blank=True, null=True, verbose_name='新截止时间')),
        ...
        migrations.AddField(
            model_name='plan',
            name='related_goal',
            field=models.ForeignKey(blank=True, help_text='选择关联的战略目标（必填）', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='related_plans', to='plan_management.strategicgoal', verbose_name='关联战略目标'),
        ),
        migrations.AddField(
            model_name='plan',
            name='responsible_department',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='plans', to='system_management.department', verbose_name='所属部门'),
        ),
        migrations.AddField(
            model_name='plan',
        ...
        migrations.AddIndex(
            model_name='strategicgoal',
            index=models.Index(fields=['level'], name='plan_strate_level_016bb2_idx'),
        ),
        migrations.AddIndex(
            model_name='strategicgoal',
            index=models.Index(fields=['owner'], name='plan_strate_owner_i_0310bc_idx'),
        ),
        migrations.AddIndex(
            model_name='strategicgoal',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['plan', '-detected_at'], name='plan_plan_i_plan_id_b71632_idx'),
        ),
        migrations.AddIndex(
            model_name='planinactivitylog',
            index=models.Index(fields=['reason', '-detected_at'], name='plan_plan_i_reason_833818_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['plan', '-requested_at'], name='plan_decisi_plan_id_584329_idx'),
        ),
        migrations.AddIndex(
            model_name='plandecision',
            index=models.Index(fields=['request_type', 'decided_at'], name='plan_decisi_request_3e1263_idx'),
        ),
        migrations.AddConstraint(
            model_name='plandecision',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['plan', '-created_time'], name='plan_plan_a_plan_id_d529da_idx'),
        ),
        migrations.AddIndex(
            model_name='planadjustment',
            index=models.Index(fields=['status'], name='plan_plan_a_status_e42430_idx'),
        ),
        migrations.AddIndex(
            model_name='plan',
        ...
        migrations.AddIndex(
            model_name='plan',
            index=models.Index(fields=['level'], name='plan_plan_level_0e88b5_idx'),
        ),
        migrations.AddIndex(
            model_name='plan',
            index=models.Index(fields=['owner'], name='plan_plan_owner_i_2eb4dc_idx'),
        ),
        migrations.AddIndex(
            model_name='plan',
        ...
        migrations.AddIndex(
            model_name='plan',
            index=models.Index(fields=['is_overdue', 'risk_level'], name='plan_plan_is_over_5a9c7b_idx'),
        ),
        migrations.AddIndex(
            model_name='plan',
            index=models.Index(fields=['plan_period', 'is_overdue'], name='plan_plan_plan_pe_6ea46c_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'is_read'], name='plan_approv_user_id_fdf6fe_idx'),
        ),
        migrations.AddIndex(
            model_name='approvalnotification',
            index=models.Index(fields=['-created_at'], name='plan_approv_created_ef6d5d_idx'),
        ),
        migrations.AddIndex(
            model_name='approvalnotification',
            index=models.Index(fields=['object_type', 'object_id'], name='plan_approv_object__3b2b49_idx'),
        ),
    ]
